...
const TWILIO_ACCOUNT_SID = process.env.TWILIO_ACCOUNT_SID || 'ACa4c5ede2bc57d012a09f0970d15ac497';
const TWILIO_AUTH_TOKEN = process.env.TWILIO_AUTH_TOKEN || '710ed2b4de1e218d407cc06323e3a29b';
const TWILIO_PHONE_NUMBER = process.env.TWILIO_PHONE_NUMBER || '+19472107506'; // Your Twilio phone number
